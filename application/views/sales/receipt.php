...
<div id="receipt_wrapper">
	...
	<th style="width:20%;text-align:left;" class="gift_receipt_element"><?php echo lang('common_price'); ?></th>
	<th style="width:15%;text-align:left;"><?php echo lang('sales_quantity'); ?></th>
	<?php if($discount_exists) 
    {
	?>
	<th style="width:16%;text-align:left;" class="gift_receipt_element"><?php echo lang('sales_discount'); ?></th>
	<?php
	}
	?>
	<th style="width:16%;text-align:right;" class="gift_receipt_element"><?php echo lang('sales_total'); ?></th>
	</tr>
	<?php
	...
	?>
		...
		<td style="text-align:left;" class="gift_receipt_element"><?php echo to_currency($item['price']); ?></td>
		<td style='text-align:left;'><?php echo to_quantity($item['quantity']); ?></td>
		<?php if($discount_exists) 
		{
		?>
		<td style='text-align:left;' class="gift_receipt_element"><?php echo $item['discount']; ?></td>
		<?php
		}
		?>
		<td style='text-align:right;' class="gift_receipt_element"><?php echo to_currency($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100); ?></td>
		</tr>
   ...
   <br />   
	...
	echo form_open("sales/change_sale/".$sale_id_raw,array('id'=>'sales_change_form')); ?>
