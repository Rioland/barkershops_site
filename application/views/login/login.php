...
<html lang="en">
<head>
    <title><?php echo $this->config->item('company').' -- '.lang('common_powered_by').' Real Dejown Integration' ?></title>
    <meta charset="UTF-8" />
                ...
                <div id="loginbox">            
                    ...
                    <div class="input-group">
                     ...
                     <?php if (isset($subscription_cancelled_within_14_days) && $subscription_cancelled_within_14_days === true) { ?>
                            <div class="alert alert-danger"><?php echo lang('login_subscription_cancelled_within_14_days'); ?></div>
                        <?php } ?>
