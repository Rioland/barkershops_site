...
$lang['config_backup_phpmyadmin_2'] = 'Your username is root and password is what you used during initial installation of Timas POS. Once logged in select your database from the panel on the left. Then select export and then submit the form.';
