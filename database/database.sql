...
INSERT INTO `phppos_app_config` VALUES ('additional_payment_types',''),('always_show_item_grid','0'),('auto_focus_on_item_after_sale_and_receiving','0'),('automatically_email_receipt','0'),('automatically_show_comments_on_receipt','0'),('averaging_method','moving_average'),('barcode_price_include_tax','0'),('calculate_average_cost_price_from_receivings','0'),('change_sale_date_when_completing_suspended_sale','0'),('change_sale_date_when_suspending','0'),('company','PHP Point Of Sale, LLC'),('currency_symbol','$'),('customers_store_accounts','0'),('date_format','middle_endian'),('default_payment_type','Cash'),('default_tax_1_name','Sales Tax'),('default_tax_1_rate',''),('default_tax_2_cumulative','0'),('default_tax_2_name','Sales Tax 2'),('default_tax_2_rate',''),('default_tax_3_name',''),('default_tax_3_rate',''),('default_tax_4_name',''),('default_tax_4_rate',''),('default_tax_5_name',''),('default_tax_5_rate',''),('default_tax_rate','8'),('disable_confirmation_sale','0'),('disable_giftcard_detection','0'),('disable_subtraction_of_giftcard_amount_from_sales','0'),('hide_customer_recent_sales','0'),('hide_dashboard_statistics','0'),('hide_layaways_sales_in_reports','0'),('hide_signature','0'),('hide_store_account_payments_in_reports','0'),('id_to_show_on_sale_interface','number'),('language','english'),('number_of_items_per_page','20'),('prices_include_tax','0'),('print_after_sale','0'),('return_policy','Change return policy'),('round_cash_on_sales','0'),('sale_prefix','POS'),('show_receipt_after_suspending_sale','0'),('spreadsheet_format','XLSX'),('time_format','12_hour'),('track_cash','0'),('version','14.3'),('website','');
...
-- Dump completed on 2014-07-16  9:05:55
